...
export default function Home() {
  ...
  const [tab, setTab] = useState<"overview" | "transactions" | "insights" | "intelligence" | "settings" | "save" | "goals" | "pix" | "income">("overview");
