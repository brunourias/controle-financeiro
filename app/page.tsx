...
function SmartInsights({ transactions, expenses, months, selectedMonth, invoiceTotal, monthlyGoal, cardLimit, setMonthlyGoal, setCardLimit, budgets, onShowMerchant, onShowFlexible }: { transactions: ParsedTransaction[]; expenses: ParsedTransaction[]; months: string[]; selectedMonth: string; invoiceTotal: number; monthlyGoal: number; cardLimit: number; setMonthlyGoal: (value: number) => void; setCardLimit: (value: number) => void; budgets: Partial<Record<Category, number>>; onShowMerchant: (merchant: string) => void; onShowFlexible: () => void }) {
