...
function SavingsCoach({ expenses, transactions, selectedMonth, goalTarget, goalSaved, goalDate, setGoalTarget, setGoalSaved, setGoalDate }: { expenses: ParsedTransaction[]; transactions: ParsedTransaction[]; selectedMonth: string; goalTarget: number; goalSaved: number; goalDate: string; setGoalTarget: (value: number) => void; setGoalSaved: (value: number) => void; setGoalDate: (value: string) => void }) {
