  ...
  const analyze = async () => {
    ...
    try {
      ...
      for (const entry of selected) {
        ...
        batchDocuments.push({ hash, name: entry.file.name, kind: entry.kind, month: result.month, pageCount: result.pageCount, transactionCount: result.transactions.length, declaredTotal: result.declaredTotal, invoiceMonthNormalized: entry.kind === "invoice" });
